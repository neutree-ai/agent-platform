 ...
 * because where it ran decides who is billed for it. user_id is compared for
 * the same reason: a workspace can be transferred to another owner.
 *
